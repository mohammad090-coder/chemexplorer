...
export const CLASS11_CATEGORIES: FormulaCategory[] = [
  {
    id: "mole",
    title: "Mole Concept",
    ...
    formulas: [
      {
        ...
        class: "11",
        explanation:
          "Number of moles equals mass divided by molar mass. n is moles (mol), m is mass (g), M is molar mass (g/mol).",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Total number of particles equals moles multiplied by Avogadro's number (6.022 × 10²³ mol⁻¹).",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "One mole of any ideal gas occupies 22.4 litres at Standard Temperature and Pressure (0°C, 1 atm).",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Molarity is the number of moles of solute per litre of solution. Measures concentration.",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Molality is moles of solute per kilogram of solvent. Unlike molarity, it is temperature-independent.",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Mole fraction of component A is moles of A divided by total moles. Sum of all mole fractions = 1.",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Percentage by mass is ratio of solute mass to total solution mass, as a percentage.",
        variables:
          "m_solute = mass of solute, m_solution = total solution mass",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Normality is equivalent weight per litre. n-factor = number of H⁺/OH⁻ ions, electrons transferred etc.",
        ...
        examples: [
          {
            ...
            solution:
              "N = n-factor × M = 2 × 1 = 2 N (since H₂SO₄ donates 2 H⁺)",
          },
        ],
      },
      {
        ...
        class: "11",
        explanation:
          "Boiling point rises when a non-volatile solute is added. i = van't Hoff factor (number of particles). Kb depends on solvent.",
        variables:
          "ΔTb = elevation, i = van't Hoff factor, Kb = ebullioscopic constant, m = molality",
        ...
        examples: [
          {
            ...
            solution:
              "ΔTb = 1 × 0.52 × 2 = 1.04°C (glucose doesn't ionise, i=1)",
          },
        ],
      },
      {
        ...
        class: "11",
        explanation:
          "A solution freezes below pure solvent's freezing point. Kf for water = 1.86 K·kg/mol.",
        variables:
          "ΔTf = depression, i = van't Hoff factor, Kf = cryoscopic constant, m = molality",
    ...
    formulas: [
      {
        ...
        class: "11",
        explanation:
          "Enthalpy change of a reaction. ΔH < 0 is exothermic; ΔH > 0 is endothermic.",
        ...
        examples: [
          {
            ...
            solution:
              "ΔH < 0, so exothermic. 286 kJ released per mole of H₂O formed.",
          },
        ],
      },
      {
        ...
        class: "11",
        explanation:
          "Relates enthalpy change to internal energy change. Δn = moles of gaseous products minus reactants.",
        variables:
          "ΔU = internal energy change, Δn = change in gaseous moles, R = 8.314 J/mol·K",
        ...
        examples: [
          {
            ...
            solution:
              "Δn = 2−4 = −2. ΔH = −85 + (−2)(8.314×10⁻³)(298) = −85 − 4.95 ≈ −89.95 kJ",
          },
        ],
      },
      {
        ...
        class: "11",
        explanation:
          "Gibbs free energy determines spontaneity. ΔG < 0: spontaneous; ΔG = 0: equilibrium; ΔG > 0: non-spontaneous.",
        variables:
          "ΔG = Gibbs energy (kJ), T = temperature (K), ΔS = entropy change (J/K)",
        ...
        examples: [
          {
            ...
            solution:
              "ΔG = −100 − (300×0.200) = −100 − 60 = −160 kJ. Spontaneous.",
          },
        ],
      },
      {
        ...
        class: "11",
        explanation:
          "Heat gained or lost = mass × specific heat capacity × temperature change.",
        variables:
          "q = heat (J), m = mass (g), c = specific heat (J/g·K), ΔT = temp change (K)",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Total enthalpy change equals sum of enthalpy changes for each step. Path-independent.",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Entropy change equals reversible heat divided by absolute temperature. Entropy measures disorder.",
        variables:
          "ΔS = entropy change (J/K), q_rev = reversible heat (J), T = temp (K)",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "For an ideal gas at constant temperature, internal energy change is zero. All absorbed heat converts to work.",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Standard Gibbs free energy relates to equilibrium constant K. Large −ΔG° means large K (reaction favours products).",
        variables:
          "R = 8.314 J/mol·K, T = temperature (K), K = equilibrium constant",
        ...
        examples: [
          {
            ...
            solution:
              "ΔG° = −(8.314)(298)ln(100) = −8.314×298×4.605 ≈ −11,400 J = −11.4 kJ",
          },
        ],
      },
    ],
    ...
    formulas: [
      {
        ...
        class: "11",
        explanation:
          "Energy of an electron in the nth orbit of hydrogen. Negative indicates bound state. E₁ = −13.6 eV (ground state).",
        variables:
          "Eₙ = energy of nth orbit (eV), n = principal quantum number",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Radius of the nth orbit in hydrogen. r₁ = 0.529 Å (Bohr radius). Increases with n².",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Energy of a photon equals Planck's constant times frequency, or hc/λ.",
        variables:
          "h = 6.626×10⁻³⁴ J·s, ν = frequency (Hz), λ = wavelength (m), c = 3×10⁸ m/s",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Every moving particle has an associated wavelength. Explains electron waves in atoms.",
        variables:
          "λ = wavelength (m), h = 6.626×10⁻³⁴ J·s, m = mass (kg), v = velocity (m/s)",
        ...
        examples: [
          {
            problem:
              "Find de Broglie wavelength of electron (m=9.1×10⁻³¹ kg) moving at 10⁶ m/s.",
            solution:
              "λ = 6.626×10⁻³⁴ / (9.1×10⁻³¹ × 10⁶) = 7.28×10⁻¹⁰ m = 0.728 nm",
          },
        ],
      },
      {
        ...
        class: "11",
        explanation:
          "Cannot simultaneously determine exact position and momentum. Fundamental limit, not experimental.",
        variables:
          "Δx = position uncertainty, Δp = momentum uncertainty, h = Planck's constant",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Wavelength of spectral lines in hydrogen. R_H = 1.097×10⁷ m⁻¹. n₂ > n₁ for emission.",
        ...
        examples: [
          {
            ...
            solution:
              "1/λ = 1.097×10⁷(1/4−1/9) = 1.097×10⁷×5/36 → λ = 656 nm (red line)",
          },
        ],
      },
      {
        ...
        class: "11",
        explanation:
          "Maximum electrons in nth shell: n=1→2, n=2→8, n=3→18, n=4→32.",
    ...
    formulas: [
      {
        ...
        class: "11",
        explanation:
          "Pressure × Volume = moles × gas constant × temperature. R = 8.314 J/mol·K or 0.0821 L·atm/mol·K.",
        variables:
          "P = pressure, V = volume (L), n = moles, R = 8.314 J/mol·K, T = temp (K)",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Total pressure of gas mixture = sum of partial pressures of each component.",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Partial pressure of gas A = its mole fraction × total pressure.",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Real gas equation. 'a' corrects for intermolecular attractions; 'b' corrects for finite molecular volume.",
        variables:
          "a = attraction correction, b = volume correction (gas-specific constants)",
        ...
        examples: [
          {
            problem:
              "At very high pressure, is ideal or van der Waals more accurate?",
            solution:
              "van der Waals — finite molecular volume (b term) becomes significant at high pressure.",
          },
        ],
      },
      {
        ...
        class: "11",
        explanation:
          "Average translational KE of a gas molecule. Depends only on temperature, not molar mass.",
    ...
    formulas: [
      {
        ...
        class: "11",
        explanation:
          "For aA + bB ⇌ cC + dD, Kc is the ratio of product concentrations to reactant concentrations, each raised to stoichiometric coefficient.",
        variables:
          "[X] = molar concentration of X, a,b,c,d = stoichiometric coefficients",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Kp uses partial pressures; Kc uses concentrations. Related via ideal gas law.",
        variables:
          "Δn = (moles gas products − moles gas reactants), R = 0.0821 L·atm/mol·K",
        ...
        examples: [
          {
            problem:
              "For N₂+3H₂⇌2NH₃, Δn=2−4=−2. At 500 K, if Kc=0.5, find Kp.",
      ...
      },
      {
        ...
        class: "11",
        explanation:
          "Ka measures strength of a weak acid. Larger Ka = stronger acid (more dissociation). pKa = −log Ka.",
        variables:
          "[H⁺] = hydrogen ion concentration, [A⁻] = conjugate base, [HA] = undissociated acid",
...
export const CLASS12_CATEGORIES: FormulaCategory[] = [
  {
    id: "electrochem",
    ...
    formulas: [
      {
        ...
        class: "12",
        explanation:
          "EMF of an electrochemical cell under standard conditions. Positive E means spontaneous.",
        ...
        examples: [
          {
            problem:
              "Zn-Cu cell: E(Cu²⁺/Cu)=+0.34V, E(Zn²⁺/Zn)=−0.76V. Find E_cell.",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Relates standard Gibbs free energy to cell potential. n = moles of electrons; F = 96485 C/mol.",
        variables:
          "n = electrons transferred, F = 96485 C/mol, E_cell = standard EMF (V)",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Cell potential at non-standard conditions. At equilibrium E=0 and Q=K_eq.",
        variables:
          "E° = standard potential, n = electrons, Q = reaction quotient, T = 298 K",
        ...
        examples: [
          {
            ...
            solution:
              "E = 1.10 − (0.0592/2)log(0.01) = 1.10 − (0.0296)(−2) = 1.10 + 0.059 = 1.159 V",
          },
        ],
      },
      {
        ...
        class: "12",
        explanation:
          "Electrical charge = current × time. Q in coulombs, I in amperes, t in seconds.",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Mass deposited at electrode during electrolysis. M = molar mass, n = valency.",
        variables:
          "m = mass (g), M = molar mass, Q = charge (C), n = valency, F = 96485 C/mol",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "At 25°C, equilibrium constant from standard cell potential.",
        variables:
          "K_eq = equilibrium constant, n = electrons, E° = standard cell potential (V)",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Molar conductivity from specific conductivity κ. Increases on dilution for weak electrolytes.",
        variables:
          "κ = specific conductivity (S/cm), M = molarity (mol/L), Λm in S·cm²/mol",
    ...
    formulas: [
      {
        ...
        class: "12",
        explanation:
          "Rate depends on concentrations raised to reaction orders m and n (determined experimentally).",
        variables:
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "For zero order, concentration decreases linearly with time. t₁/₂ = [A]₀/2k.",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "For first order, ln[A] vs time is linear. Radioactive decay and drug elimination follow this.",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "For second order, 1/[A] vs time is linear. t₁/₂ = 1/(k[A]₀).",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Rate constant depends exponentially on activation energy. Higher Ea = slower reaction.",
        variables:
          "A = pre-exponential factor, Ea = activation energy (J/mol), R = 8.314 J/mol·K, T = temp (K)",
        keywords: [
          "Arrhenius",
          "activation energy",
        ...
        examples: [
          {
            ...
            solution:
              "k = 10¹³ × e^(−50000/(8.314×500)) = 10¹³ × e^(−12.02) ≈ 10¹³ × 6×10⁻⁶ ≈ 6×10⁷",
          },
        ],
      },
      {
        ...
        class: "12",
        explanation:
          "Compares rate constants at two temperatures to find activation energy.",
        ...
        examples: [
          {
            ...
            solution:
              "ln(2) = (Ea/8.314)(1/300−1/310). Ea = 0.693×8.314×300×310/10 ≈ 53.6 kJ/mol",
          },
        ],
      },
    ],
    ...
    formulas: [
      {
        ...
        class: "12",
        explanation:
          "Self-condensation of acetaldehyde in dilute NaOH. Produces a β-hydroxy aldehyde. Can dehydrate to α,β-unsaturated carbonyl.",
        ...
        examples: [
          {
            ...
            solution:
              "Dilute NaOH (or acid). The enolate acts as nucleophile attacking carbonyl carbon of another aldehyde.",
          },
        ],
      },
      {
        ...
        class: "12",
        explanation:
          "Disproportionation of aldehydes with no α-H in conc. NaOH. One oxidised (acid), other reduced (alcohol).",
        ...
        examples: [
          {
            ...
            solution:
              "It has α-H, so it prefers Aldol condensation over Cannizzaro.",
          },
        ],
      },
      {
        ...
        class: "12",
        explanation:
          "Sodium phenoxide + CO₂ under pressure and heat → sodium salicylate → acidified → salicylic acid.",
        ...
        examples: [
          {
            ...
            solution:
              "Aspirin (acetylsalicylic acid) — the active ingredient in Aspirin tablets.",
          },
        ],
      },
      {
        ...
        class: "12",
        explanation:
          "Phenol + chloroform in alkaline solution → o-hydroxybenzaldehyde (salicylaldehyde). Electrophilic substitution.",
        ...
        examples: [
          {
            ...
            solution:
              "Dichlorocarbene (:CCl₂) from CHCl₃ + NaOH — it is the active electrophile.",
          },
        ],
      },
      {
        ...
        class: "12",
        explanation:
          "SN2 reaction of alkoxide with alkyl halide → ether. Best with primary alkyl halides.",
        ...
        examples: [
          {
            ...
            solution:
              "CH₃O⁻ + C₂H₅Br → CH₃OC₂H₅ + Br⁻. Use methoxide (strong base) with ethyl bromide (primary).",
          },
        ],
      },
      {
        ...
        class: "12",
        explanation:
          "Electrophilic aromatic substitution using Lewis acid (AlCl₃). Adds alkyl group to benzene ring.",
        ...
        examples: [
          {
            problem:
              "Why does rearrangement occur in Friedel-Crafts alkylation?",
            solution:
              "The carbocation intermediate can rearrange to a more stable form before attacking the ring.",
          },
        ],
      },
      {
        ...
        class: "12",
        explanation:
          "EAS to introduce acyl group. No rearrangement unlike alkylation. Gives ketone.",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Reduction of nitrile to primary amine using H₂/Ni or LiAlH₄. Key amine synthesis method.",
        variables:
          "Catalyst: Ni/Raney Ni or LiAlH₄ (lithium aluminium hydride)",
    ...
    formulas: [
      {
        ...
        class: "12",
        explanation:
          "EAN = atomic number − oxidation state + electrons donated by ligands. Stable complexes often reach noble gas EAN.",
        variables:
          "Z = atomic number, each ligand donates 2 electrons (2-electron donor)",
        ...
        examples: [
          {
            problem:
              "Find EAN for [Fe(CO)₅]. Fe has Z=26, OS=0, 5 CO each donates 2e.",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "CFSE measures stability from d-orbital splitting in octahedral field. t₂g electrons lower energy; eg raise it.",
        variables:
          "Δo = crystal field splitting energy, n(t₂g), n(eg) = electrons in each set",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Primary valence = metal oxidation state, satisfied by counter-ions.",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Secondary valence = coordination number = ligands directly bonded in coordination sphere.",
    ...
    formulas: [
      {
        ...
        class: "12",
        explanation:
          "Density of crystal from unit cell parameters. Z = atoms per unit cell, a = edge length.",
        variables:
          "Z = atoms/unit cell, M = molar mass, ρ = density, NA = 6.022×10²³, a = edge length (cm)",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "In close-packed structures, the radius of atom that fits in an octahedral void = 0.414 times the sphere radius.",
        ...
        examples: [
          {
            problem:
              "If anion radius = 100 pm, what cation fits in octahedral void?",
      ...
      },
      {
        ...
        class: "12",
        explanation:
          "Face-centred cubic (cubic close packing) has 74% packing efficiency — the maximum for identical spheres.",
    ...
    formulas: [
      {
        ...
        class: "12" as const,
        explanation:
          "DBE (Degree of Unsaturation / Index of Hydrogen Deficiency) counts rings + pi bonds. Each ring or double bond = 1 DBE. Triple bond = 2 DBE. Oxygen and sulfur are NOT counted.",
        variables:
          "C = carbons, N = nitrogens, H = hydrogens, X = halogens. O/S not counted.",
        ...
        examples: [
          {
            ...
            solution:
              "DBE = (2x6 + 2 - 5 - 1) / 2 = 8/2 = 4. (Benzene ring: 3 C=C + 1 ring = 4)",
          },
          {
            problem: "Find DBE for C4H6.",
            solution:
              "DBE = (8 + 2 - 6)/2 = 4/2 = 2. Could be 2 double bonds, 1 triple bond, or 1 ring + 1 double bond.",
          },
        ],
      },
      {
        ...
        class: "12" as const,
        explanation:
          "Complete combustion of alkane CnH(2n+2) gives CO2 and H2O. The O2 coefficient is (3n+1)/2. For methane (n=1): CH4 + 2O2 -> CO2 + 2H2O.",
        ...
        examples: [
          {
            ...
            solution:
              "O2 = (3x4+1)/2 = 13/2. Full: 2C4H10 + 13O2 -> 8CO2 + 10H2O.",
          },
        ],
      },
      {
        ...
        class: "12" as const,
        explanation:
          "In HX addition to an unsymmetrical alkene, H attaches to the carbon with more hydrogens (less substituted). The X goes to the more substituted carbon because that carbocation is more stable.",
        variables:
          "HX = HBr, HCl, HI, H2SO4/H2O. Anti-Markovnikov applies only to HBr + ROOR.",
        keywords: [
          "Markovnikov",
          "HBr",
          "alkene",
        ...
        examples: [
          {
            ...
            solution:
              "Markovnikov: H to less-substituted C. Product: CH3CHBrCH3 (2-bromopropane).",
          },
          {
            problem: "Product of HBr + CH3CH=CH2 (with ROOR peroxide).",
            solution:
              "Anti-Markovnikov (radical): Br to less-substituted C. Product: CH3CH2CH2Br (1-bromopropane).",
          },
        ],
      },
    ],
    ...
    formulas: [
      {
        ...
        class: "12" as const,
        explanation:
          "The Nernst equation gives cell potential under non-standard conditions. Q is the reaction quotient. At equilibrium E = 0 and log K = nE0/0.0592.",
        variables:
          "E = cell potential (V), E0 = standard potential (V), n = electrons transferred, Q = reaction quotient",
        ...
        examples: [
          {
            problem:
              "Calculate E for Cu2+/Cu when [Cu2+] = 0.01 M. E0 = +0.34 V.",
            solution:
              "E = 0.34 - (0.0592/2) log (1/0.01) = 0.34 - 0.0296 x 2 = 0.281 V.",
          },
        ],
      },
      {
        ...
        class: "12" as const,
        explanation:
          "Molar conductance Lm = specific conductance (k) times 1000 divided by molarity M (units: S cm2/mol). Kohlrausch law: Lm0 = sum of individual ionic conductances. Degree of dissociation a = Lm/Lm0.",
        variables:
          "k = specific conductance (S/cm), M = molarity (mol/L), Lm0 = limiting molar conductance",
        ...
        examples: [
          {
            problem:
              "Find Lm0 for CH3COOH given: CH3COONa = 91, HCl = 426, NaCl = 126 S cm2/mol.",
            solution:
              "Lm0(CH3COOH) = 91 + 426 - 126 = 391 S cm2/mol (Kohlrausch law).",
          },
        ],
      },
    ],
    ...
    formulas: [
      {
        ...
        class: "12" as const,
        explanation:
          "Gibbs free energy determines spontaneity at constant T and P. dG < 0: spontaneous. dG = 0: equilibrium. dG > 0: non-spontaneous. Also: dG0 = -RT ln K = -nFE0.",
        variables:
          "dH = enthalpy change (kJ/mol), T = temperature (K), dS = entropy change (J/mol K)",
        keywords: [
          "Gibbs",
          "spontaneity",
          "entropy",
        ...
        examples: [
          {
            problem:
              "dH = -92 kJ/mol, dS = -198 J/mol K at 298 K (Haber). Find dG.",
            solution:
              "dG = -92000 - 298 x (-198) = -92000 + 58998 = -33002 J/mol = -33 kJ/mol. Spontaneous.",
          },
        ],
      },
      {
        ...
        class: "12" as const,
        explanation:
          "Shows how equilibrium constant K changes with temperature. Exothermic (dH < 0): K decreases with rising T. Endothermic (dH > 0): K increases with T. Used to optimize industrial reactions.",
        variables:
          "K1, K2 = equilibrium constants at T1, T2; dH0 = standard enthalpy (J/mol); R = 8.314 J/mol K",
        ...
        examples: [
          {
            problem:
              "dH0 = +30 kJ/mol, K(300K) = 0.5. Does K increase at 320 K?",
            solution:
              "Endothermic: K increases with T. ln(K2/0.5) = -30000/8.314 x (1/320-1/300) = 0.75. K2 = 0.5 x e^0.75 = 1.06. K increased.",
          },
        ],
      },
    ],
    ...
    formulas: [
      {
        ...
        class: "12" as const,
        explanation:
          "For first-order reaction, ln[A] decreases linearly with time. Slope of ln[A] vs t = -k. Half-life t(1/2) = 0.693/k (independent of initial concentration). Radioactive decay is always first order.",
        variables:
          "[A] = concentration at time t, [A]0 = initial concentration, k = rate constant (s^-1)",
        ...
        examples: [
          {
            problem:
              "1st order reaction, k = 0.693 s-1. Fraction remaining after 2 s?",
            solution:
              "t(1/2) = 0.693/0.693 = 1 s. After 2 s = 2 half-lives. Fraction = (1/2)^2 = 0.25 (25%).",
          },
        ],
      },
      {
        ...
        class: "12" as const,
        explanation:
          "For second-order reaction, 1/[A] increases linearly with time. Half-life t(1/2) = 1/(k[A]0) depends on initial concentration (unlike 1st order). Slope of 1/[A] vs t = +k.",
        variables:
          "[A] = concentration at time t, [A]0 = initial concentration, k = rate constant (L/mol/s)",
        ...
        examples: [
          {
            problem:
              "2nd order: k = 0.01 L/mol/s, [A]0 = 2 mol/L. Find t(1/2).",
      ...
      },
      {
        ...
        class: "12" as const,
        explanation:
          "Derived from Arrhenius equation: k = A*e^(-Ea/RT). Allows calculation of Ea from rate constants at two temperatures. Arrhenius plot of ln k vs 1/T is linear with slope -Ea/R.",
        variables:
          "k1, k2 = rate constants at T1, T2 (in K); Ea = activation energy (J/mol); R = 8.314 J/mol K",
        keywords: [
          "Arrhenius",
          "activation energy",
          "temperature",
        ...
        examples: [
          {
            ...
            solution:
              "ln 2 = Ea/8.314 x (1/300-1/310). 1/300-1/310 = 1.075e-4. Ea = 0.693x8.314/1.075e-4 = 53600 J/mol = 53.6 kJ/mol.",
          },
        ],
      },
    ],
    ...
    formulas: [
      {
        ...
        class: "11" as const,
        explanation:
          "Matter has wave properties. The de Broglie wavelength is inversely proportional to momentum. For electron accelerated through V volts: lambda = 12.27/sqrt(V) angstroms.",
        variables:
          "h = 6.626e-34 J s, m = mass (kg), v = velocity (m/s), KE = kinetic energy (J)",
        ...
        examples: [
          {
            problem:
              "Find de Broglie wavelength for electron accelerated through 100 V.",
            solution:
              "lambda = 12.27/sqrt(100) = 12.27/10 = 1.227 angstroms (X-ray range).",
          },
        ],
      },
      {
        ...
        class: "11" as const,
        explanation:
          "Cannot simultaneously determine exact position and momentum of a particle. This is a fundamental quantum property, not an experimental limitation. It is the reason electrons exist in probability clouds (orbitals) rather than fixed orbits.",
        variables:
          "dx = uncertainty in position (m), dp = uncertainty in momentum (kg m/s), h = Planck constant",
        ...
        examples: [
          {
            problem:
              "If dx = 1e-10 m, find minimum dv for electron (m = 9.1e-31 kg).",
            solution:
              "dp >= h/(4*pi*dx) = 6.626e-34/(4*pi*1e-10) = 5.27e-25. dv = dp/m = 5.27e-25/9.1e-31 = 5.8e5 m/s.",
          },
        ],
      },
      {
        ...
        class: "11" as const,
        explanation:
          "Bohr radius rn = 0.529n^2/Z angstroms and orbit energy En = -13.6Z^2/n^2 eV for hydrogen-like atoms. Negative sign = electron is bound. Photon energy: dE = 13.6Z^2(1/n1^2 - 1/n2^2) eV.",
        variables:
          "n = principal quantum number, Z = atomic number, r in angstroms, E in eV",
        ...
        examples: [
          {
            ...
            solution:
              "r1(He+) = 0.529*1/2 = 0.265 angstroms. E1(H) = -13.6*1/1 = -13.6 eV.",
          },
        ],
      },
    ],
...
export function getFormulaOfTheDay(): Formula {
