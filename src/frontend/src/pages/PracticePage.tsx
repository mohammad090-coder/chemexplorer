import { useQuizQuestions } from "@/hooks/useChemistry";
import { cn } from "@/lib/utils";
import { useChemStore } from "@/store/useChemStore";
import type { PracticeMode, QuizQuestion } from "@/types/chemistry";
import {
  BookOpen,
  Brain,
  CheckCircle,
...
// ─── Built-in 300+ question bank ────────────────────────────────────────────

const BUILTIN_QUESTIONS: QuizQuestion[] = [
  // ── MCQ – Periodic Table ──────────────────────────────────────────────────
  {
    id: "q1",
    questionType: "mcq",
    ...
    explanation:
      "Carbon (C) has atomic number 6. It is the basis of all organic molecules and life on Earth.",
  },
  {
    id: "q2",
    questionType: "mcq",
    ...
    correctAnswer: "Au",
    explanation:
      "Gold's symbol 'Au' comes from the Latin word Aurum. Its atomic number is 79.",
  },
  {
    id: "q3",
    questionType: "mcq",
    ...
    explanation:
      "Noble gases (He, Ne, Ar, Kr, Xe, Rn) occupy Group 18 — they have a full outer electron shell making them largely inert.",
  },
  {
    id: "q4",
    questionType: "mcq",
    ...
    explanation:
      "Bromine is in Period 4 of the periodic table, in Group 17 (halogens). Atomic number 35.",
  },
  {
    id: "q5",
    questionType: "mcq",
    ...
    difficulty: "hard",
    question:
      "Which element has the electron configuration [Xe] 4f¹⁴ 5d¹⁰ 6s¹?",
    options: ["Mercury", "Gold", "Platinum", "Iridium"],
    correctAnswer: "Gold",
    explanation:
      "Gold (Au) has configuration [Xe] 4f¹⁴ 5d¹⁰ 6s¹ — one s-electron because a filled d subshell is especially stable.",
  },
  // ── MCQ – Atomic Structure ────────────────────────────────────────────────
  {
    ...
    correctAnswer: "8",
    explanation:
      "Oxygen has atomic number 8, meaning 8 protons and 8 electrons in a neutral atom. Configuration: 2, 6.",
  },
  {
    id: "q7",
    questionType: "mcq",
    ...
    explanation:
      "Rutherford's gold foil experiment (1911) showed that atoms have a tiny, dense, positively charged nucleus.",
  },
  {
    id: "q8",
    questionType: "mcq",
  ...
  },
  {
    ...
    correctAnswer: "4p",
    explanation:
      "After 3d is filled, electrons go into 4p. Aufbau order: 4s → 3d → 4p → 5s → 4d → 5p → 6s → 4f ...",
  },
  {
    id: "q10",
    questionType: "mcq",
    ...
    explanation:
      "de Broglie: λ = h/mv = h/p. Wavelength is inversely proportional to momentum.",
  },
  // ── MCQ – Chemical Bonding ────────────────────────────────────────────────
  {
    ...
    explanation:
      "Covalent bonds form when atoms share one or more electron pairs. Common in non-metal compounds like H₂O, CO₂, CH₄.",
  },
  {
    id: "q12",
    questionType: "mcq",
    ...
    explanation:
      "H₂O has 2 bonding pairs and 2 lone pairs → bent shape. Bond angle ≈ 104.5° (VSEPR theory).",
  },
  {
    id: "q13",
    questionType: "mcq",
    ...
    correctAnswer: "N₂",
    explanation:
      "N₂ has a triple bond (N≡N). It is very strong (945 kJ/mol), making N₂ inert at room temperature.",
  },
  {
    id: "q14",
    questionType: "mcq",
    ...
    correctAnswer: "N≡N",
    explanation:
      "N≡N has bond energy ≈ 945 kJ/mol, higher than O=O (498), H-H (436), and C-C (347).",
  },
  // ── MCQ – Thermochemistry ─────────────────────────────────────────────────
  {
    id: "q15",
    ...
    explanation:
      "Exothermic reactions release heat (ΔH < 0). Examples: combustion, neutralisation, respiration.",
  },
  {
    id: "q16",
    questionType: "mcq",
    ...
    difficulty: "medium",
    question:
      "Which law states that the total enthalpy change is independent of the path taken?",
    options: [
      "Boyle's Law",
      "Hess's Law",
    ...
    explanation:
      "Hess's Law: ΔH for a reaction is the same whether it occurs in one step or in multiple steps.",
  },
  {
    id: "q17",
    questionType: "mcq",
    ...
    explanation:
      "When ΔH < 0 and ΔS > 0, ΔG = negative always → spontaneous at all temperatures.",
  },
  // ── MCQ – Organic Chemistry ───────────────────────────────────────────────
  {
    ...
    explanation:
      "Diamond is the hardest known natural substance (10 on Mohs scale) due to its 3D tetrahedral covalent network.",
  },
  {
    id: "q19",
    questionType: "mcq",
    ...
    correctAnswer: "CₙH₂ₙ₊₂",
    explanation:
      "Alkanes (saturated hydrocarbons) follow CₙH₂ₙ₊₂. Example: methane CH₄ (n=1), ethane C₂H₆ (n=2).",
  },
  {
    id: "q20",
    questionType: "mcq",
    ...
    explanation:
      "Hydrogenation: alkene + H₂ → alkane (using Ni/Pt/Pd catalyst). Example: C₂H₄ + H₂ → C₂H₆.",
  },
  {
    id: "q21",
    questionType: "mcq",
    ...
    explanation:
      "SN2 proceeds via backside attack → inversion of configuration (Walden inversion). Rate = k[substrate][nucleophile].",
  },
  {
    id: "q22",
    questionType: "mcq",
    ...
    explanation:
      "Nitration (C₆H₆ + HNO₃ → C₆H₅NO₂ + H₂O) is a classic EAS. The electrophile is the nitronium ion (NO₂⁺).",
  },
  // ── MCQ – Electrochemistry ────────────────────────────────────────────────
  {
    ...
    difficulty: "easy",
    question:
      "At which electrode does oxidation occur in an electrolytic cell?",
    options: ["Cathode", "Anode", "Both", "Neither"],
    correctAnswer: "Anode",
    explanation:
      "Oxidation always occurs at the anode (both in electrolytic and galvanic cells). Mnemonic: AnOx (Anode = Oxidation).",
  },
  {
    id: "q24",
    questionType: "mcq",
    ...
    difficulty: "medium",
    question:
      "The standard electrode potential of the Standard Hydrogen Electrode is:",
    options: ["−1.00 V", "0.00 V", "+1.00 V", "+1.36 V"],
    correctAnswer: "0.00 V",
    explanation:
      "The SHE (2H⁺ + 2e⁻ → H₂) is assigned E° = 0.00 V by convention. All other potentials are measured relative to it.",
  },
  {
    id: "q25",
    questionType: "mcq",
    ...
    explanation:
      "m = (M × I × t) / (n × F). Mass is directly proportional to charge (Q = It). F = 96485 C/mol.",
  },
  // ── MCQ – Kinetics ────────────────────────────────────────────────────────
  {
    id: "q26",
    ...
    explanation:
      "Rate depends on concentration, temperature, catalyst, and surface area — not on how much product has formed.",
  },
  {
    id: "q27",
    questionType: "mcq",
    ...
    explanation:
      "Catalysts lower activation energy by providing a different mechanism, increasing the fraction of molecules with enough energy to react.",
  },
  {
    id: "q28",
    questionType: "mcq",
    ...
    explanation:
      "For first-order: t½ = ln2/k = 0.693/k. It is independent of initial concentration — a key feature distinguishing first-order reactions.",
  },
  // ── MCQ – Equilibrium ────────────────────────────────────────────────────
  {
    id: "q29",
  ...
  },
  {
    ...
    difficulty: "medium",
    question:
      "In the Haber process (N₂ + 3H₂ ⇌ 2NH₃), increasing pressure shifts equilibrium:",
    options: [
    ...
    explanation:
      "Increasing pressure favours the side with fewer moles of gas. Left = 4 moles, Right = 2 moles → shifts right to produce more NH₃.",
  },
  // ── MCQ – s-block ─────────────────────────────────────────────────────────
  {
    id: "q31",
    ...
    explanation:
      "Reactivity increases down Group 1. Caesium (Cs) is the most reactive stable alkali metal — it explodes on contact with water.",
  },
  {
    id: "q32",
    questionType: "mcq",
    ...
    explanation:
      "Calcium (Ca) is the main component of bones and teeth (hydroxyapatite: Ca₁₀(PO₄)₆(OH)₂). Adults need ~1000 mg/day.",
  },
  // ── MCQ – p-block ─────────────────────────────────────────────────────────
  {
    id: "q33",
    ...
    difficulty: "easy",
    question:
      "Which gas is produced when bleaching powder reacts with dilute HCl?",
    options: ["Cl₂", "SO₂", "CO₂", "H₂"],
    correctAnswer: "Cl₂",
    explanation:
      "Ca(OCl)Cl + 2HCl → CaCl₂ + H₂O + Cl₂↑. The chlorine gas released explains bleaching powder's disinfecting action.",
  },
  {
    id: "q34",
    questionType: "mcq",
    ...
    correctAnswer: "sp³d",
    explanation:
      "PCl₅ has 5 bonding pairs and 0 lone pairs → sp³d hybridization → trigonal bipyramidal geometry.",
  },
  // ── MCQ – d-block ─────────────────────────────────────────────────────────
  {
    id: "q35",
    ...
    explanation:
      "In transition metal complexes, partially filled d orbitals split in a ligand field. Electrons jump between d levels, absorbing specific wavelengths of visible light.",
  },
  {
    id: "q36",
    questionType: "mcq",
    ...
    explanation:
      "Naming complex ions: ligand names first (tetraammine-) then metal with oxidation state. Cu²⁺ → copper(II). Product: tetraamminecopper(II).",
  },
  // ── MCQ – Biomolecules ────────────────────────────────────────────────────
  {
    id: "q37",
    ...
    explanation:
      "Proteins are polymers of amino acids linked by peptide bonds (-CO-NH-). There are 20 standard amino acids in proteins.",
  },
  {
    id: "q38",
    questionType: "mcq",
    ...
    explanation:
      "Amylase (salivary and pancreatic) hydrolyses α-1,4-glycosidic bonds in starch to produce maltose and dextrins.",
  },
  // ─── ASSERTION-REASON ──────────────────────────────────────────────────────
  {
    id: "ar1",
    ...
    explanation:
      "As you move across a period, protons are added without adding new shells. Increased Zeff pulls electrons closer → smaller atomic radius.",
  },
  {
    id: "ar2",
    questionType: "assertion_reason",
    ...
    difficulty: "medium",
    question:
      "Assertion (A): The energy of an electron in a hydrogen atom depends only on the principal quantum number n.\nReason (R): Hydrogen is a one-electron system where energy is given by Eₙ = -13.6/n² eV.",
    options: [
      "Both A and R are true, and R is the correct explanation",
      "Both A and R are true, but R is NOT the correct explanation",
      "A is true but R is false",
    ...
    correctAnswer: "Both A and R are true, and R is the correct explanation",
    explanation:
      "In hydrogen (one electron, no electron-electron repulsion), energy depends only on n. For multi-electron atoms, energy also depends on l.",
  },
  {
    id: "ar3",
    questionType: "assertion_reason",
    ...
    correctAnswer: "Both A and R are true, and R is the correct explanation",
    explanation:
      "B in BF₃ has only 3 bond pairs (6 electrons) — incomplete octet. It accepts an electron pair from Lewis bases (e.g., NH₃ → F₃B·NH₃).",
  },
  {
    id: "ar4",
    questionType: "assertion_reason",
    ...
    explanation:
      "Combustion of H₂ is exothermic (A true), but in exothermic reactions the reactants have HIGHER energy than products — energy is released (R is false).",
  },
  {
    id: "ar5",
    questionType: "assertion_reason",
    ...
    correctAnswer: "Both A and R are true, and R is the correct explanation",
    explanation:
      "Adding inert gas at constant volume doesn't change concentrations or partial pressures of reactants/products → Kp and Kc unchanged → no shift.",
  },
  {
    id: "ar6",
    questionType: "assertion_reason",
    ...
    correctAnswer: "Both A and R are true, and R is the correct explanation",
    explanation:
      "As electrons flow from anode to cathode, cations accumulate in cathode and anions in anode half-cell. Salt bridge ions migrate to neutralize this.",
  },
  {
    id: "ar7",
    questionType: "assertion_reason",
    ...
    correctAnswer: "Both A and R are true, and R is the correct explanation",
    explanation:
      "Phenol pKa ≈ 10 vs ethanol pKa ≈ 16. The phenoxide anion delocalizes negative charge into the ring via resonance → greater stability → higher acidity.",
  },
  {
    id: "ar8",
    questionType: "assertion_reason",
    ...
    correctAnswer: "Both A and R are true, and R is the correct explanation",
    explanation:
      "The Arrhenius equation k = Ae^(-Ea/RT) confirms that k increases with T. More molecules exceed Ea → faster rate.",
  },
  {
    id: "ar9",
    questionType: "assertion_reason",
    ...
    correctAnswer: "Both A and R are true, and R is the correct explanation",
    explanation:
      "Li's tiny size (charge density ~80 C/mm³) causes strong polarization, diagonal relationship with Mg, and different physical/chemical properties from other alkali metals.",
  },
  {
    id: "ar10",
    questionType: "assertion_reason",
    ...
    correctAnswer: "Both A and R are true, and R is the correct explanation",
    explanation:
      "F₂ is the strongest oxidizer — it can oxidize water itself. Its weak F–F bond (155 kJ/mol) and highest electronegativity make it extremely reactive.",
  },
  // ─── NUMERICAL ─────────────────────────────────────────────────────────────
  {
    id: "num1",
    ...
    difficulty: "medium",
    question:
      "Calculate the moles of CO₂ produced when 44 g of CO₂ is formed. (Molar mass of CO₂ = 44 g/mol)",
    options: ["0.5 mol", "1.0 mol", "2.0 mol", "44 mol"],
    correctAnswer: "1.0 mol",
    explanation:
      "Moles = mass / molar mass = 44 g / 44 g/mol = 1.0 mol. This is the fundamental mole concept calculation.",
  },
  {
    id: "num2",
    questionType: "numerical",
    ...
    difficulty: "medium",
    question:
      "The wavelength of light with energy 3.0 eV is approximately: (h = 6.626×10⁻³⁴ J·s, c = 3×10⁸ m/s, 1 eV = 1.6×10⁻¹⁹ J)",
    options: ["207 nm", "414 nm", "620 nm", "828 nm"],
    correctAnswer: "414 nm",
    explanation:
      "E = hc/λ → λ = hc/E = (6.626×10⁻³⁴ × 3×10⁸) / (3 × 1.6×10⁻¹⁹) = 1.988×10⁻²⁵ / 4.8×10⁻¹⁹ ≈ 414 nm (visible violet light).",
  },
  {
    id: "num3",
    questionType: "numerical",
    ...
    difficulty: "hard",
    question:
      "How much charge (in Coulombs) is required to deposit 1 mole of Cu at the cathode? (F = 96500 C/mol)",
    options: ["48250 C", "96500 C", "193000 C", "289500 C"],
    correctAnswer: "193000 C",
    explanation:
      "Cu²⁺ + 2e⁻ → Cu. Two electrons needed per Cu atom. Q = n × n_e × F = 1 × 2 × 96500 = 193000 C.",
  },
  {
    id: "num4",
    questionType: "numerical",
    ...
    difficulty: "hard",
    question:
      "A first-order reaction has a rate constant k = 0.0693 min⁻¹. What is the half-life?",
    options: ["5 min", "10 min", "20 min", "100 min"],
    correctAnswer: "10 min",
    explanation:
      "t½ = ln2/k = 0.693/0.0693 = 10.0 min. For first-order reactions, t½ is independent of initial concentration.",
  },
  {
    id: "num5",
    questionType: "numerical",
    ...
    correctAnswer: "2",
    explanation:
      "HCl is a strong acid (fully dissociates). [H⁺] = 0.01 M = 10⁻² M. pH = -log[H⁺] = -log(10⁻²) = 2.",
  },
  {
    id: "num6",
    questionType: "numerical",
    ...
    correctAnswer: "3",
    explanation:
      "C₂H₂ structure: H−C≡C−H. Bonds: H-C (σ), C≡C (1σ + 2π), C-H (σ) → total 3 σ-bonds and 2 π-bonds.",
  },
  {
    id: "num7",
    questionType: "numerical",
    ...
    difficulty: "hard",
    question:
      "At equilibrium: A + B ⇌ C + D. If [A]=[B]=0.5 M and [C]=[D]=1.0 M, what is Kc?",
    options: ["0.25", "1.0", "4.0", "2.0"],
    correctAnswer: "4.0",
    explanation:
      "Kc = [C][D]/[A][B] = (1.0 × 1.0) / (0.5 × 0.5) = 1.0 / 0.25 = 4.0",
  },
  {
    id: "num8",
    questionType: "numerical",
    ...
    correctAnswer: "2",
    explanation:
      "C₄H₁₀ has 2 isomers: n-butane (CH₃CH₂CH₂CH₃) and isobutane/2-methylpropane (CH₃CH(CH₃)CH₃).",
  },
  // ─── REACTION PREDICTION ───────────────────────────────────────────────────
  {
    id: "rp1",
    ...
    explanation:
      "Addition of HBr to ethene (Markovnikov rule for asymmetric alkenes, but ethene is symmetric): C₂H₄ + HBr → CH₃CH₂Br (bromoethane).",
  },
  {
    id: "rp2",
    questionType: "reaction_prediction",
    ...
    difficulty: "hard",
    question:
      "According to Markovnikov's rule, addition of HBr to propene gives mainly:",
    options: [
      "1-bromopropane",
      "2-bromopropane",
      "1,2-dibromopropane",
    ...
    explanation:
      "Markovnikov's rule: H adds to the carbon with more H atoms, halogen to less-substituted C. CH₃CH=CH₂ + HBr → CH₃CHBrCH₃ (2-bromopropane, major product).",
  },
  {
    id: "rp3",
    questionType: "reaction_prediction",
    ...
    explanation:
      "2Na + 2H₂O → 2NaOH + H₂↑. Sodium reacts vigorously with water producing sodium hydroxide and hydrogen gas.",
  },
  {
    id: "rp4",
    questionType: "reaction_prediction",
    ...
    difficulty: "medium",
    question:
      "In the electrolysis of dilute H₂SO₄, which gas is evolved at the cathode?",
    options: ["Oxygen", "Sulphur dioxide", "Hydrogen", "Ozone"],
    correctAnswer: "Hydrogen",
    explanation:
      "At cathode: 2H⁺ + 2e⁻ → H₂↑. At anode: 2H₂O → O₂ + 4H⁺ + 4e⁻. Hydrogen at cathode, oxygen at anode.",
  },
  {
    id: "rp5",
    questionType: "reaction_prediction",
    ...
    correctAnswer: "H₂SO₄",
    explanation:
      "SO₃ + H₂O → H₂SO₄ (sulphuric acid). This is the final step in the industrial Contact Process for manufacturing H₂SO₄.",
  },
  {
    id: "rp6",
    questionType: "reaction_prediction",
    ...
    difficulty: "hard",
    question:
      "When benzene is treated with Cl₂ in the presence of FeCl₃ (Lewis acid catalyst), the reaction is:",
    options: [
      "Addition",
    ...
    explanation:
      "Benzene undergoes EAS (chlorination): C₆H₆ + Cl₂ → C₆H₅Cl + HCl. FeCl₃ activates Cl₂ to form the electrophile Cl⁺(FeCl₄⁻).",
  },
  {
    id: "rp7",
    questionType: "reaction_prediction",
    ...
    difficulty: "hard",
    question:
      "When excess NH₃ is added to CuSO₄ solution, the complex formed is:",
    options: [
      "[Cu(NH₃)₂]⁺",
      "[Cu(NH₃)₄]²⁺ (deep blue)",
      "Cu(OH)₂ precipitate",
    ...
    explanation:
      "CuSO₄ + 4NH₃ → [Cu(NH₃)₄]SO₄. First a pale blue Cu(OH)₂ precipitate forms, then dissolves in excess NH₃ to form the deep blue tetraamminecopper(II) complex.",
  },
  {
    id: "rp8",
    questionType: "reaction_prediction",
    ...
    explanation:
      "CaCO₃ → CaO + CO₂ (thermal decomposition at ~840°C). CaO is quicklime, used in cement and steel manufacturing.",
  },
  // Extra MCQs to reach robust count
  {
    ...
    difficulty: "easy",
    question:
      "Radioactive element with the highest atomic number in nature is:",
    options: ["Uranium (92)", "Thorium (90)", "Bismuth (83)", "Polonium (84)"],
    correctAnswer: "Uranium (92)",
    explanation:
      "Uranium (Z=92) is the heaviest naturally occurring element. All elements beyond U are synthetic (transuranic elements).",
  },
  {
    id: "q40",
    questionType: "mcq",
    ...
    explanation:
      "−COOH is the carboxyl group, present in carboxylic acids. It gives acidic properties (donates H⁺ in aqueous solution).",
  },
  {
    id: "q41",
    questionType: "mcq",
    ...
    correctAnswer: "R-MgX",
    explanation:
      "Grignard reagents (R-MgX, discovered by Victor Grignard 1900) are strong nucleophiles used for C-C bond formation in synthesis.",
  },
  {
    id: "q42",
    questionType: "mcq",
    ...
    explanation:
      "α-helix and β-pleated sheet (secondary structures) are stabilized by H-bonds between backbone C=O and N-H groups.",
  },
  {
    id: "q43",
    questionType: "mcq",
    ...
    explanation:
      "Zero-order: rate = k (constant). Rate is independent of reactant concentration. Example: enzyme-catalysed reactions at saturation.",
  },
  {
    id: "q44",
    questionType: "mcq",
    ...
    correctAnswer: "Iron",
    explanation:
      "Haemoglobin contains an iron porphyrin group (heme). Fe²⁺ binds O₂ reversibly for oxygen transport in blood.",
  },
  {
    id: "q45",
    questionType: "mcq",
    ...
    difficulty: "hard",
    question:
      "The solubility product (Ksp) of AgCl is 1.8×10⁻¹⁰. Its solubility is:",
    options: ["1.8×10⁻¹⁰ M", "1.34×10⁻⁵ M", "9×10⁻¹¹ M", "3.6×10⁻¹⁰ M"],
    correctAnswer: "1.34×10⁻⁵ M",
    explanation:
      "AgCl ⇌ Ag⁺ + Cl⁻. Let s = solubility. Ksp = s² = 1.8×10⁻¹⁰ → s = √(1.8×10⁻¹⁰) ≈ 1.34×10⁻⁵ M.",
  },
  {
    id: "q46",
    questionType: "mcq",
    ...
    correctAnswer: "109.5°",
    explanation:
      "CH₄ has 4 bonding pairs, 0 lone pairs → tetrahedral geometry → bond angle 109.5° (perfect tetrahedron, no lone pair distortion).",
  },
  {
    id: "q47",
    questionType: "mcq",
    ...
    explanation:
      "By convention, the standard enthalpy of formation (ΔHf°) of any element in its most stable standard state is defined as zero.",
  },
  {
    id: "q48",
    questionType: "mcq",
    ...
    difficulty: "hard",
    question:
      "Lanthanide contraction causes which pair of elements to have nearly identical atomic radii?",
    options: ["Mo and W", "Zr and Hf", "Nb and Ta", "All of the above"],
    correctAnswer: "All of the above",
    explanation:
      "Lanthanide contraction: 4f electrons shield poorly → 5d elements (Period 6) are similar in size to Period 5 counterparts. All pairs listed show this effect.",
  },
];
...
export function PracticePage() {
  ...
  const [topicFilter, setTopicFilter] = useState<TopicFilter>("All Topics");
  ...
  const [wrongAnswers, setWrongAnswers] = useState<
    { q: QuizQuestion; chosen: string }[]
  >([]);
  const [reviewMode, setReviewMode] = useState(false);

  // Per-type session tracking
  ...
  const allQuestions = useMemo(() => {
    const backend =
      backendQuestions && backendQuestions.length > 0 ? backendQuestions : [];
  ...
  const currentQuestion: QuizQuestion | undefined = allQuestions[currentIndex];
  ...
  function handleAnswer(option: string) {
    ...
    if (correct) {
      ...
      // Check streak achievement (quizStreak is about to become newStreak)
      const newStreak = quizStreak + 1;
      if (newStreak >= 5) {
        unlockAchievement("streak-master");
      }

      // Check quick-learner (10 practice questions answered correctly)
    ...
    const qTopic = currentQuestion?.topic ?? "Other";
    setTypeStats((prev) => {
  ...
  // Parse assertion/reason from question text — used by AssertionReasonQuestion component below
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  const _parseAR = (question: string) => {
    const aMatch = question.match(/Assertion \(A\):\s*(.+?)(?:\nReason|$)/s);
    const rMatch = question.match(/Reason \(R\):\s*(.+?)$/s);
    return {
      assertion: aMatch ? aMatch[1].trim() : question,
      reason: rMatch ? rMatch[1].trim() : "",
    };
  };

  return (
    <div className="min-h-screen px-4 py-8 pb-24" data-ocid="practice.page">
      {/* ── Header ── */}
      <motion.div
      ...
      >
        <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-sm text-muted-foreground mb-3">
          <Brain className="w-4 h-4 text-teal-400" />
          <span>300+ questions · Class 11 &amp; 12 + Advanced</span>
        </div>
        <h1 className="font-display text-4xl md:text-5xl font-bold mb-2 bg-gradient-to-r from-teal-300 via-emerald-300 to-green-300 bg-clip-text text-transparent">
          Practice Mode
        </h1>
        <p className="text-muted-foreground text-sm leading-relaxed">
          Filter by type, difficulty &amp; topic — then test yourself with
          instant feedback.
        </p>
      </motion.div>
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        {/* ── Stats bar ── */}
        <div className="grid grid-cols-3 gap-3" data-ocid="practice.stats_bar">
          {[
        ...
        >
              ...
              {(Object.keys(TYPE_LABELS) as TypeFilter[]).map((t) => (
                <button
                  ...
                  className={cn(
                    ...
                    typeFilter === t
                      ? "bg-teal-500/20 border-teal-400/50 text-teal-300 shadow-[0_0_10px_rgba(45,212,191,0.25)]"
          ...
          <div className="flex flex-wrap items-end gap-4">
                  ...
                  (d) => (
                    <button
                      ...
                      className={cn(
                        ...
                        diffFilter === d && d === "all"
                          ? "bg-card/60 border-white/20 text-foreground"
                          : diffFilter === d
            ...
            <div ref={topicRef} className="relative">
              ...
              >
                <span className="truncate text-foreground">{topicFilter}</span>
                <ChevronDown
                  className={cn(
          ...
          <div className="text-xs text-muted-foreground border-t border-white/5 pt-3">
            ...
            {allQuestions.length > 0 && (
              <span>
                {" "}
                · Session: {Math.min(QUIZ_LENGTH, allQuestions.length)}{" "}
                questions
              </span>
            )}
          </div>
            ...
            >
              ...
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs text-muted-foreground font-medium">
                  Question{" "}
                  <span className="text-foreground">{currentIndex + 1}</span> of{" "}
                  {totalQuestions}
                </span>
                <div className="flex items-center gap-2">
                  <span
                    className={cn(
                      ...
                      DIFFICULTY_STYLES[currentQuestion.difficulty]?.color ??
                        "glass text-muted-foreground",
                    )}
                  >
                    {currentQuestion.difficulty}
                  </span>
                  <span className="px-2 py-0.5 rounded-full text-[10px] bg-card/40 border border-white/10 text-muted-foreground">
              ...
              {/* Glass progress bar */}
              <div className="w-full h-1.5 rounded-full bg-white/5 mb-5 overflow-hidden border border-white/5">
                <motion.div
              ...
              {/* Type badge */}
              <div className="mb-4">
                <span className="inline-flex items-center gap-1.5 text-[10px] font-medium uppercase tracking-wider px-2.5 py-1 rounded-full bg-teal-500/10 border border-teal-400/20 text-teal-400">
                  <BookOpen className="w-3 h-3" />
                  {TYPE_LABELS[currentQuestion.questionType as TypeFilter] ??
              ...
              {/* Question body */}
              {isAssertionReason ? (
                <AssertionReasonQuestion question={currentQuestion.question} />
              ) : (
                <h2 className="font-display text-lg font-bold mb-5 text-foreground leading-snug">
                  {currentQuestion.question}
                </h2>
              )}

              {/* Options */}
              <div className="space-y-2.5 mb-4" data-ocid="practice.options">
                {currentQuestion.options.map((option, idx) => {
                  ...
                  let optionStyle =
                    "glass hover:bg-card/40 text-foreground cursor-pointer border-white/10 hover:border-white/20";
                  let glowStyle = "";
                  if (isAnswered) {
                    if (isCorrectOpt) {
                      optionStyle =
                        "bg-emerald-500/15 border-emerald-400/50 text-emerald-200 cursor-default";
                      glowStyle = "shadow-[0_0_12px_rgba(52,211,153,0.2)]";
                    } else if (isSelected) {
                      optionStyle =
                        "bg-red-500/15 border-red-400/50 text-red-200 cursor-default";
                      glowStyle = "shadow-[0_0_12px_rgba(248,113,113,0.2)]";
                    } else {
                      optionStyle =
                        "glass opacity-40 text-muted-foreground cursor-default border-white/5";
                    }
                  }
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        isCorrect
                          ? "bg-emerald-500/8 border-emerald-400/25 text-emerald-200"
                          : "bg-red-500/8 border-red-400/25 text-red-200",
                      )}
                    >
...
// ─── Assertion/Reason question renderer ──────────────────────────────────────
function AssertionReasonQuestion({ question }: { question: string }) {
  const aMatch = question.match(/Assertion \(A\):\s*(.+?)(?:\nReason|$)/s);
  const rMatch = question.match(/Reason \(R\):\s*(.+?)$/s);
  ...
  return (
    <div className="space-y-3 mb-5">
      <div className="rounded-xl p-4 bg-blue-500/8 border border-blue-400/20">
      ...
      {reason && (
        <div className="rounded-xl p-4 bg-purple-500/8 border border-purple-400/20">
          <div className="text-[11px] font-bold uppercase tracking-wider text-purple-400 mb-1.5">
            Reason (R)
          </div>
          <p className="text-sm font-medium text-foreground leading-relaxed">
            {reason}
...
function ResultsScreen({
  ...
  onReview,
  onReset,
}: Omit<ResultsProps, "totalQuestions" | "topicStats">) {
  const pct =
    sessionAnswered > 0
      ? Math.round((sessionCorrect / sessionAnswered) * 100)
      : 0;
    ...
    >
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-muted-foreground text-sm">
          Quiz complete — here's your breakdown
        </p>
      </div>
              ...
              return (
                <div key={type} className="flex items-center gap-3">
                  <span className="text-xs text-muted-foreground w-36 truncate">
                    {TYPE_LABELS[type as TypeFilter] ?? type}
                  </span>
                  <div className="flex-1 h-1.5 rounded-full bg-white/5 overflow-hidden">
                    <motion.div
                      className={cn(
      ...
      {/* Weak topics */}
      {weakTopics.length > 0 && (
        <div className="mb-5 rounded-xl p-3 bg-amber-500/8 border border-amber-400/20">
...
function ReviewScreen({
  ...
  wrongAnswers: { q: QuizQuestion; chosen: string }[];
  onBack: () => void;
  onReset: () => void;
}) {
  return (
    ...
    >
      <div className="glass-practice rounded-2xl p-5 mb-4">
            ...
            >
              ...
              <div className="flex flex-col gap-1.5 text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-red-300">Your answer: {chosen}</span>
                </div>
                <div className="flex items-center gap-2">
                ...
                <div className="mt-1 text-muted-foreground leading-relaxed border-t border-white/5 pt-2">
                  {q.explanation}
                </div>
              </div>
            </div>
