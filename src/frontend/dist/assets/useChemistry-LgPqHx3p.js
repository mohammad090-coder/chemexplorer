...
import { z as lebEncode, H as concat, I as slebEncode, J as lebDecode, K as safeRead, M as PipeArrayBuffer, N as safeReadUint8, O as Principal$1, Q as iexp2, U as writeUIntLE, V as readUIntLE, W as writeIntLE, Y as readIntLE, _ as slebDecode, $ as uint8ToDataView, a0 as InputError, a1 as CborEncodeErrorCode, a2 as CborDecodeErrorCode, a3 as ExpiryJsonDeserializeErrorCode, a4 as utf8ToBytes, a5 as _validateObject, a6 as isHash, a7 as abytes, a8 as mod, a9 as concatBytes, aa as bytesToNumberBE, ab as isBytes, ac as FpInvertBatch, ad as Field, ae as _createCurveFields, af as wNAF, ag as ensureBytes, ah as _abool2, ai as _abytes2, aj as normalizeZ, ak as mulEndoUnsafe, al as bytesToHex, am as pippenger, an as inRange, ao as memoized, ap as negateCt, aq as bitMask, ar as bitLen, as as validateField, at as getMinHashLength, au as mapHashToField, av as randomBytes, aw as FpPow, ax as FpLegendre, ay as notImplemented, az as bitGet, aA as sha256, aB as numberToBytesBE, aC as UNREACHABLE_ERROR, aD as UnknownError, aE as HashTreeDecodeErrorCode, aF as uint8Equals, aG as ProtocolError, aH as CertificateVerificationErrorCode, aI as TrustError, aJ as CertificateTimeErrorCode, aK as UnexpectedErrorCode, aL as CertificateHasTooManyDelegationsErrorCode, aM as CertificateNotAuthorizedErrorCode, aN as MissingLookupValueErrorCode, aO as DerKeyLengthMismatchErrorCode, aP as DerPrefixMismatchErrorCode, aQ as LookupErrorCode, aR as MalformedLookupFoundValueErrorCode, aS as hexToBytes, aT as ExternalError, aU as MissingRootKeyErrorCode, aV as AgentError, aW as wrapDER, aX as ED25519_OID, aY as unwrapDER, aZ as DerDecodeErrorCode, a_ as hashOfMap, a$ as IC_RESPONSE_DOMAIN_SEPARATOR, b0 as MalformedPublicKeyErrorCode, b1 as ed25519, b2 as QuerySignatureVerificationFailedErrorCode, b3 as AnonymousIdentity, b4 as IngressExpiryInvalidErrorCode, b5 as CreateHttpAgentErrorCode, b6 as IdentityInvalidErrorCode, b7 as requestIdOf, b8 as HttpV3ApiNotSupportedErrorCode, b9 as TimeoutWaitingForResponseErrorCode, ba as uint8FromBufLike, bb as HttpErrorCode, bc as TransportError, bd as HttpFetchErrorCode, be as MalformedSignatureErrorCode, bf as CertificateOutdatedErrorCode, bg as MissingSignatureErrorCode, bh as HttpDefaultFetchErrorCode, bi as RequestStatusDoneNoReplyErrorCode, bj as RejectError, bk as CertifiedRejectErrorCode, bl as InvalidReadStateRequestErrorCode, bm as MissingCanisterIdErrorCode, bn as UncertifiedRejectErrorCode, bo as UncertifiedRejectUpdateErrorCode, bp as Subscribable, bq as pendingThenable, br as resolveEnabled, bs as shallowEqualObjects, bt as resolveStaleTime, bu as noop, bv as environmentManager, bw as isValidTimeout, bx as timeUntilStale, by as timeoutManager, bz as focusManager, bA as fetchState, bB as replaceData, bC as notifyManager, r as reactExports, bD as shouldThrowError, bE as useQueryClient } from "./index-DyyHqAHL.js";
...
const ChemicalProduct = Record({
  "coefficient": Nat,
  "name": Text,
  "formula": Text,
  "symbol": Text
});
const ChemicalReactant = Record({
  "coefficient": Nat,
  "name": Text,
  "symbol": Text
});
const ChemicalReaction = Record({
  "id": Text,
  "name": Text,
...
const MetalReaction = Record({
  "reactionType": Text,
  "observation": Text,
  "equation": Text,
  "partner": Text
});
const ReactivityMetal = Record({
  "name": Text,
  "rank": Nat,
...
Service({
  "getAllElements": Func([], [Vec(Element)], ["query"]),
  "getElement": Func([Text], [Opt(Element)], ["query"]),
  "getFavorites": Func([], [Vec(Text)], ["query"]),
  "getMyProfile": Func([], [Opt(Profile)], ["query"]),
  "getMyStats": Func([], [UserStats], ["query"]),
  "getPublicProfile": Func([Principal], [Opt(Profile)], ["query"]),
  "getQuizQuestion": Func([Text], [Opt(QuizQuestion)], ["query"]),
  "getQuizQuestions": Func(
    [Text, Text],
    [Vec(QuizQuestion)],
    ["query"]
  ),
  "getReaction": Func([Text], [Opt(ChemicalReaction)], ["query"]),
  "getReactions": Func([], [Vec(ChemicalReaction)], ["query"]),
  "getReactionsByCategory": Func(
    [Text],
    [Vec(ChemicalReaction)],
    ["query"]
  ),
  "getReactionsByType": Func(
    [Text],
    [Vec(ChemicalReaction)],
    ["query"]
  ),
  "getReactivityMetal": Func(
    [Text],
    [Opt(ReactivityMetal)],
    ["query"]
  ),
  "getReactivitySeries": Func([], [Vec(ReactivityMetal)], ["query"]),
  "recordActivity": Func([], [], []),
  "searchElements": Func([Text], [Vec(Element)], ["query"]),
  "searchReactions": Func(
    [Text],
    [Vec(ChemicalReaction)],
    ["query"]
  ),
  "toggleFavorite": Func([Text], [Bool], []),
  "updateProgress": Func([Nat], [], []),
  "upsertMyProfile": Func([ProfileInput], [Profile], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const Element2 = IDL2.Record({
    "atomicMass": IDL2.Float64,
    "electronConfiguration": IDL2.Text,
    "ionizationEnergy": IDL2.Float64,
    "period": IDL2.Nat,
    "density": IDL2.Float64,
    "electronegativity": IDL2.Float64,
    "name": IDL2.Text,
    "uses": IDL2.Vec(IDL2.Text),
    "description": IDL2.Text,
    "meltingPoint": IDL2.Float64,
    "state": IDL2.Text,
    "colorHex": IDL2.Text,
    "group": IDL2.Nat,
    "category": IDL2.Text,
    "block": IDL2.Text,
    "boilingPoint": IDL2.Float64,
    "atomicNumber": IDL2.Nat,
    "symbol": IDL2.Text,
    "atomicRadius": IDL2.Float64,
    "facts": IDL2.Vec(IDL2.Text)
  });
  ...
  const UserStats2 = IDL2.Record({
    "progressScore": IDL2.Nat,
    "savedItemsCount": IDL2.Nat,
  ...
  const QuizQuestion2 = IDL2.Record({
    ...
    "questionType": IDL2.Text,
    "options": IDL2.Vec(IDL2.Text)
  });
  const ChemicalProduct2 = IDL2.Record({
    "coefficient": IDL2.Nat,
    "name": IDL2.Text,
    "formula": IDL2.Text,
    "symbol": IDL2.Text
  });
  const ChemicalReactant2 = IDL2.Record({
    "coefficient": IDL2.Nat,
    "name": IDL2.Text,
    "symbol": IDL2.Text
  });
  const ChemicalReaction2 = IDL2.Record({
    "id": IDL2.Text,
    "name": IDL2.Text,
    "balancedEquation": IDL2.Text,
    "description": IDL2.Text,
    "reactionType": IDL2.Text,
    "category": IDL2.Text,
    "energyChange": IDL2.Text,
    "products": IDL2.Vec(ChemicalProduct2),
    "namedReaction": IDL2.Text,
    "reactants": IDL2.Vec(ChemicalReactant2),
    "observations": IDL2.Vec(IDL2.Text)
  });
  const MetalReaction2 = IDL2.Record({
    "reactionType": IDL2.Text,
    "observation": IDL2.Text,
    "equation": IDL2.Text,
    "partner": IDL2.Text
  });
  const ReactivityMetal2 = IDL2.Record({
    "name": IDL2.Text,
    "rank": IDL2.Nat,
    "interestingFacts": IDL2.Vec(IDL2.Text),
    "reactions": IDL2.Vec(MetalReaction2),
    "symbol": IDL2.Text
  });
  ...
  return IDL2.Service({
    "getAllElements": IDL2.Func([], [IDL2.Vec(Element2)], ["query"]),
    "getElement": IDL2.Func([IDL2.Text], [IDL2.Opt(Element2)], ["query"]),
    "getFavorites": IDL2.Func([], [IDL2.Vec(IDL2.Text)], ["query"]),
    "getMyProfile": IDL2.Func([], [IDL2.Opt(Profile2)], ["query"]),
    ...
    "getQuizQuestion": IDL2.Func(
      [IDL2.Text],
      [IDL2.Opt(QuizQuestion2)],
      ["query"]
    ),
    "getQuizQuestions": IDL2.Func(
      [IDL2.Text, IDL2.Text],
      [IDL2.Vec(QuizQuestion2)],
      ["query"]
    ),
    "getReaction": IDL2.Func(
      [IDL2.Text],
      [IDL2.Opt(ChemicalReaction2)],
      ["query"]
    ),
    "getReactions": IDL2.Func([], [IDL2.Vec(ChemicalReaction2)], ["query"]),
    "getReactionsByCategory": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(ChemicalReaction2)],
      ["query"]
    ),
    "getReactionsByType": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(ChemicalReaction2)],
      ["query"]
    ),
    "getReactivityMetal": IDL2.Func(
      [IDL2.Text],
      [IDL2.Opt(ReactivityMetal2)],
      ["query"]
    ),
    "getReactivitySeries": IDL2.Func([], [IDL2.Vec(ReactivityMetal2)], ["query"]),
    "recordActivity": IDL2.Func([], [], []),
    "searchElements": IDL2.Func([IDL2.Text], [IDL2.Vec(Element2)], ["query"]),
    "searchReactions": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(ChemicalReaction2)],
      ["query"]
    ),
    "toggleFavorite": IDL2.Func([IDL2.Text], [IDL2.Bool], []),
    "updateProgress": IDL2.Func([IDL2.Nat], [], []),
    "upsertMyProfile": IDL2.Func([ProfileInput2], [Profile2], [])
  });
};
...
class Backend {
  ...
  async getQuizQuestions(arg0, arg1) {
    if (this.processError) {
      try {
  ...
  async getReactionsByCategory(arg0) {
    if (this.processError) {
      try {
...
function from_candid_Profile_n3(_uploadFile, _downloadFile, value) {
...
function to_candid_ProfileInput_n9(_uploadFile, _downloadFile, value) {
...
function getCanisterId() {
  return typeof process !== "undefined" && (define_process_env_default == null ? void 0 : define_process_env_default.CANISTER_ID_BACKEND) || "";
}
function getActor() {
  const canisterId = getCanisterId();
  if (!canisterId) return null;
  const noopUpload = async () => new Uint8Array();
  const noopDownload = async () => ({ directURL: "" });
  return createActor(canisterId, noopUpload, noopDownload);
}
function mapMetal(m2) {
  return {
    ...m2,
    rank: m2.rank,
    reactions: m2.reactions.map((r2) => ({ ...r2 }))
  };
}
function mapReaction(r2) {
  return {
    ...r2,
    reactants: r2.reactants.map((x2) => ({ ...x2 })),
    products: r2.products.map((x2) => ({ ...x2 }))
  };
}
function mapQuiz(q2) {
  return { ...q2 };
}
function useReactivitySeries() {
  return useQuery({
...
function useReactions(searchTerm) {
  return useQuery({
    queryKey: ["reactions", "all"],
    queryFn: async () => {
      const actor = getActor();
      if (!actor) return [];
      const data = await actor.getReactions();
      return data.map(mapReaction);
    },
    staleTime: 5 * 60 * 1e3
  });
}
function useQuizQuestions(difficulty, topic) {
  return useQuery({
...
export {
  useReactions as a,
  useQuizQuestions as b,
  useReactivitySeries as u
};
