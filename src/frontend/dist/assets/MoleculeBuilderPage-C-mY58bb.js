import { y as useAnimationLevel, r as reactExports, bO as isMobileDevice, j as jsxRuntimeExports } from "./index-DyyHqAHL.js";
const ATOM_CONFIG = {
  C: {
    color: "#6b7280",
...
const BOND_WIDTH = { 1: 2, 2: 3, 3: 4 };
const BOND_OFFSET = { 1: 0, 2: 4, 3: 5 };
const BOND_ANGLES = {
  linear: "180°",
  "linear (diatomic)": "180°",
  ...
  if (lower.includes("linear") || lower.includes("diatomic")) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "6", cy: "12", r: "5", fill: "rgba(99,202,255,0.7)" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "42", cy: "12", r: "5", fill: "rgba(99,202,255,0.7)" })
        ]
      }
    );
  }
  if (lower.includes("bent") || lower.includes("v-shape")) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "6", cy: "24", r: "5", fill: "rgba(239,68,68,0.8)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: "10",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "5", r: "5", fill: "rgba(59,130,246,0.8)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: "25",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "42", cy: "24", r: "5", fill: "rgba(239,68,68,0.8)" })
        ]
      }
    );
  }
  if (lower.includes("trigonal planar") || lower.includes("planar hexagonal") || lower.includes("planar")) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        width: "48",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "4", r: "5", fill: "rgba(52,211,153,0.8)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: "20",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "5", cy: "35", r: "5", fill: "rgba(52,211,153,0.8)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "43", cy: "35", r: "5", fill: "rgba(52,211,153,0.8)" })
        ]
      }
    );
  }
  if (lower.includes("tetrahedral")) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "4", r: "5", fill: "rgba(251,146,60,0.9)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: "24",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "5", cy: "40", r: "4", fill: "rgba(251,146,60,0.8)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "43", cy: "40", r: "4", fill: "rgba(251,146,60,0.8)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "40", r: "4", fill: "rgba(251,146,60,0.6)" })
        ]
      }
    );
  }
  if (lower.includes("trigonal pyramidal")) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "4", r: "5", fill: "rgba(236,72,153,0.9)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: "24",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "8", cy: "36", r: "4", fill: "rgba(236,72,153,0.7)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "40", cy: "36", r: "4", fill: "rgba(236,72,153,0.7)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "37", r: "4", fill: "rgba(236,72,153,0.5)" })
        ]
      }
    );
  }
...
function atomSignature(atoms) {
  const count = {};
  for (const a of atoms) count[a.type] = (count[a.type] ?? 0) + 1;
  return Object.entries(count).sort(([a], [b]) => a.localeCompare(b)).map(([t, n]) => `${t}${n}`).join("");
}
const COMPOUND_DB = {
...
function drawAtom(ctx, atom, selected, pending) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: cfg.fullName.slice(0, 4)
          }
        )
      ]
    }
...
function MoleculeBuilderPage() {
  const animLevel = useAnimationLevel();
  const mobile = reactExports.useMemo(() => isMobileDevice(), []);
  const canvasRef = reactExports.useRef(null);
  const containerRef = reactExports.useRef(null);
  const rafRef = reactExports.useRef(0);
  const rotationRef = reactExports.useRef(0);
  const isDraggingPaletteAtom = reactExports.useRef(null);
  const [atoms, setAtoms] = reactExports.useState([]);
  const [bonds, setBonds] = reactExports.useState([]);
  const [nextId, setNextId] = reactExports.useState(1);
  const [selectedAtomId, setSelectedAtomId] = reactExports.useState(null);
  const [pendingBondId, setPendingBondId] = reactExports.useState(null);
  const [bondType, setBondType] = reactExports.useState(1);
  const [rotating, setRotating] = reactExports.useState(false);
  const [compound, setCompound] = reactExports.useState(null);
  const [canvasSize, setCanvasSize] = reactExports.useState({ w: 600, h: 500 });
  const [draggingAtomId, setDraggingAtomId] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    ...
    const speed = animLevel === "minimal" ? 3e-3 : 7e-3;
    const loop = () => {
  ...
  const hitAtom = reactExports.useCallback(
    (x, y) => {
      for (let i = atoms.length - 1; i >= 0; i--) {
        const a = atoms[i];
        const r = ATOM_CONFIG[a.type].radius + 4;
        const dx = x - a.x;
        const dy = y - a.y;
  ...
  const clientToCanvas = reactExports.useCallback((clientX, clientY) => {
    var _a;
    const rect = (_a = canvasRef.current) == null ? void 0 : _a.getBoundingClientRect();
    if (!rect) return { x: 0, y: 0 };
    return { x: clientX - rect.left, y: clientY - rect.top };
  }, []);
  const handleBondClick = reactExports.useCallback(
    (hitId) => {
      if (pendingBondId === null) {
        ...
        if (existing) {
          setBonds(
            (prev) => prev.map(
              (b) => b.from === from && b.to === to || b.from === to && b.to === from ? { ...b, order: b.order % 3 + 1 } : b
            )
          );
        } else {
  ...
  const handleCanvasMouseDown = reactExports.useCallback(
    (e) => {
  ...
  const handleCanvasMouseUp = reactExports.useCallback(() => setDraggingAtomId(null), []);
  const handleCanvasTouchStart = reactExports.useCallback(
    (e) => {
  ...
  const handleCanvasTouchMove = reactExports.useCallback(
    (e) => {
  ...
  const handleCanvasTouchEnd = reactExports.useCallback(() => setDraggingAtomId(null), []);
  ...
  const handleDeleteSelected = reactExports.useCallback(() => {
    ...
    setBonds(
      (prev) => prev.filter((b) => b.from !== selectedAtomId && b.to !== selectedAtomId)
    );
    setSelectedAtomId(null);
    setPendingBondId(null);
  }, [selectedAtomId]);
  ...
  const handleSaveImage = reactExports.useCallback(() => {
    const canvas = canvasRef.current;
    if (!canvas) return;
  ...
  const handlePaletteDragStart = reactExports.useCallback(
    (e, type) => {
  ...
  const handlePaletteDragEnd = reactExports.useCallback(() => {
    isDraggingPaletteAtom.current = null;
  }, []);
  const handlePaletteTap = reactExports.useCallback(
    (type) => {
      const { w, h } = canvasSize;
      const jitter = {
  ...
  const BondSelector = ({ compact }) => /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: [1, 2, 3].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      onClick: () => setBondType(b),
      className: [
        compact ? "shrink-0 rounded-lg px-2.5 py-2 text-[11px]" : "rounded-lg px-2 py-1.5 text-xs",
        "font-semibold border transition-all duration-200",
        bondType === b ? b === 1 ? "bg-white/20 border-white/40 text-foreground" : b === 2 ? "bg-cyan-500/20 border-cyan-400/50 text-cyan-300" : "bg-violet-500/20 border-violet-400/50 text-violet-300" : "bg-transparent border-white/10 text-muted-foreground hover:border-white/25"
      ].join(" "),
      "data-ocid": compact ? `builder.mobile_bond_${b}` : `builder.bond_type_${b}`,
      children: bondLabel[b]
    },
    b
  )) });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 px-4 pt-4 pb-2 flex items-center justify-between gap-3 border-b border-white/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-xl text-foreground leading-tight", children: "Molecule Builder" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: mobile ? "Tap palette to add atoms. Tap two atoms to bond." : "Drag atoms onto canvas. Click two atoms to create a bond." })
          ] }),
          compound && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden sm:flex items-center gap-2 glass rounded-xl px-3 py-1.5 border border-white/10 shrink-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-semibold text-sm", children: compound.formula }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: compound.name }),
            shapeBadge && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `text-[10px] font-bold uppercase tracking-wide rounded px-1.5 py-0.5 border ${shapeBadge.cls}`,
                children: shapeBadge.label
              }
            )
          ] })
        ] }),
            ...
            children: [
              !mobile && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "aside",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground font-semibold uppercase tracking-wider px-1", children: "Atoms" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-1.5", children: PALETTE_ATOMS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      PaletteAtomBtn,
                      {
                        type: t,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 pt-3 border-t border-white/10 flex flex-col gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground font-semibold uppercase tracking-wider px-1", children: "Bond" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(BondSelector, {})
                    ] })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-3 right-3 flex items-center gap-2 z-10", children: [
                      selectedAtomId !== null && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          ...
                          className: [
                            ...
                            rotating ? "border-accent/50 text-accent bg-accent/10" : "border-white/15 text-muted-foreground hover:border-white/30"
                          ].join(" "),
                          "data-ocid": "builder.rotate_toggle",
                          children: rotating ? "Stop Rotation" : "Auto Rotate"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                    ...
                    pendingBondId !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-3 left-1/2 -translate-x-1/2 z-10 glass rounded-full px-4 py-1.5 text-xs text-amber-300 border border-amber-400/30 pointer-events-none", children: [
                      "Click another atom to create a ",
                      bondLabel[bondType].toLowerCase(),
                      " ",
                      "bond"
                    ] })
                  ]
              ...
              !mobile && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "aside",
                {
                  ...
                  children: [
                    compound ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-xl p-4 border border-white/10", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-display font-bold text-accent mb-0.5", children: compound.formula }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-semibold text-foreground mb-2", children: compound.name }),
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                            {
                              className: [
                                ...
                                compound.type.toLowerCase().includes("organic") && !compound.type.toLowerCase().includes("inorganic") ? "bg-emerald-500/20 text-emerald-300" : "bg-sky-500/20 text-sky-300"
                              ].join(" "),
                              children: compound.type
                            }
                          ),
                          shapeBadge && /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "span",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-xl px-4 py-3 border border-white/10", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground uppercase tracking-wider mb-2", children: "Geometry" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "opacity-80 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShapeIcon, { shape: compound.shape }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-foreground font-medium", children: compound.shape }),
                            bondAngle && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mt-0.5", children: [
                              "Bond angle:",
                              " ",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-semibold", children: bondAngle })
                            ] })
                          ] })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-xl px-4 py-3 border border-white/10", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground uppercase tracking-wider mb-1", children: "Hybridization" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-foreground font-medium", children: compound.hybridization })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass rounded-xl px-4 py-3 border border-white/10", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-muted-foreground uppercase tracking-wider mb-1", children: "Uses" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-foreground leading-relaxed", children: compound.uses })
                      ] })
                    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full text-center gap-3 opacity-50", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl", children: "⚗️" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Build a molecule to detect compound info" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground/60", children: "Try H₂O, CO₂, CH₄, NH₃, HCl, NaCl, SO₂…" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-auto pt-3 border-t border-white/10", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground font-semibold uppercase tracking-wider mb-2", children: "Bond Legend" }),
                      [1, 2, 3].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1.5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: bondLabel[b] })
                      ] }, b))
                    ] })
                  ]
                }
        ...
        mobile && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground shrink-0 mr-1", children: "Add:" }),
              PALETTE_ATOMS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                PaletteAtomBtn,
                {
                  type: t,
                  onDragStart: handlePaletteDragStart,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-white/10 shrink-0 mx-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(BondSelector, { compact: true }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-white/10 shrink-0 mx-1" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: [
                    ...
                    rotating ? "border-accent/50 text-accent bg-accent/10" : "border-white/10 text-muted-foreground"
                  ].join(" "),
                  "data-ocid": "builder.mobile_rotate_toggle",
                  children: rotating ? "Stop" : "Rotate"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
        ...
        mobile && compound && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-accent shrink-0", children: compound.formula }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground shrink-0", children: compound.name }),
              shapeBadge && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
              ...
              bondAngle && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground shrink-0", children: bondAngle }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground shrink-0", children: compound.hybridization })
            ]
          }
        )
      ]
